...
const HomeEntrenador = () => {
  ...
  const handleSaveObservaciones = () => {
    const updatedClient = { ...selectedClient, circuitos: selectedClient.circuitos.map(circuito => ({ ...circuito, observaciones: observaciones[circuito.id_circuito] || circuito.observaciones })) };
